...
| `matter_id` | matter provenance when available |
...
A matter brief may carry at most `context.memory.fact-tokens=100` of memory
facts and must label their provenance. Write decisions do not receive unrelated
memory by default.
