...
| Path | Owns | Contract |
| --- | --- | --- |
| /data | store, workspace, skill library, config | [../architecture/sandbox/workspace.md](../architecture/sandbox/workspace.md) |
| /data/workspace | the project directory the agent works on | [../architecture/sandbox/workspace.md](../architecture/sandbox/workspace.md) |
