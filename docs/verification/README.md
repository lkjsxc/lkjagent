...
This directory owns semantic verification beyond topology. Topology proves that
files and links exist; semantic gates prove objective fit, connectedness,
provider-neutral wording, and non-mock content.
...
- Docker Compose commands remain in [../operations/verification.md](../operations/verification.md).
