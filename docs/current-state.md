...
| Artifact lifecycle | Scaffold, audit, `artifact.next`, bounded write examples, root-scoped cursors, and normalized artifact ledger store APIs exist. Runtime artifact tools do not yet write ledger rows, and semantic readiness remains incomplete. |
