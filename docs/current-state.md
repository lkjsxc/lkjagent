...
The main index also maps stage ranges to numbered main files. Design and main
files carry matching headings, section roles, objective anchors, main-range
coverage, sequence ledgers, anchor-linked body spines, per-part content
details, and continuity handoffs while preserving the exact count.
