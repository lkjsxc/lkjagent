...
brief count inside a larger file-count request, including Japanese design-file
phrases, the scaffold uses it for design memos when the exact total can still retain main content.
