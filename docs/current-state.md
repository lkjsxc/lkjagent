...
| Provider exchange logging | SQLite schema, store APIs, atomic filesystem writer, request, response, parse, admission, observation, error, index, CLI list/show, and focused store/runtime/CLI tests exist. Export remains open. |
