...
marking, audit observations tied to `artifact_ledger_id`, and daemon `agent.done` refusals for unresolved ledger
weak paths exist. Invalid-root adoption markers and proof for every close path remain open.
