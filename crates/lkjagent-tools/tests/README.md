...
- [artifact_kind.rs](artifact_kind.rs): artifact kind metadata matching fixtures.
...
- [artifact_write_ledger.rs](artifact_write_ledger.rs): artifact cursor completion write fixtures.
...
- [doc_scaffold_existing.rs](doc_scaffold_existing.rs): existing-root scaffold refusal fixtures.
