...
#[test]
fn english_article_scale_file_count_request_adds_approximate_file_guard() {
    let mut state = ControlState::default();

    state.start_task("Create about a hundred files total for docs and main content.");
...
#[test]
fn english_bare_scale_file_count_request_adds_approximate_file_guard() {
    let mut state = ControlState::default();

    state.start_task("Create roughly hundred files total for docs and main content.");
