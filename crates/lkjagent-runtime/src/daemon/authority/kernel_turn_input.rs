...
pub(super) fn adapter_input(
    ...
    Ok(SnapshotAdapterInput {
        ...
        artifact_plan_status: artifact.plan_status,
        artifact_atom_total: artifact.atom_total,
        artifact_atom_ready: artifact.atom_ready,
        artifact_atom_missing: artifact.atom_missing,
        artifact_next_atom: artifact.next_atom,
        artifact_next_path: artifact.next_path,
        artifact_active_contract: artifact.active_contract,
        artifact_measured_total: artifact.measured_total,
        artifact_accepted_floor: artifact.accepted_floor,
        artifact_assembly_pending: artifact.assembly_pending,
        artifact_readiness: artifact.readiness,
        artifact_completion_blockers: artifact.completion_blockers,
