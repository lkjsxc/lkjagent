...
const SUITES: &[Suite] = &[
    ...
    Suite { package: "lkjagent-core", target: "recovery_prompt", minimum_tests: 1 },
    Suite { package: "lkjagent-core", target: "runtime_eligibility", minimum_tests: 6 },
    Suite { package: "lkjagent-app", target: "recovery_ladder", minimum_tests: 3 },
    Suite { package: "lkjagent-app", target: "progress_vector", minimum_tests: 3 },
    Suite { package: "lkjagent-app", target: "runtime_budget", minimum_tests: 2 },
    Suite { package: "lkjagent-app", target: "runtime_wait", minimum_tests: 1 },
    Suite { package: "lkjagent-app", target: "endpoint_wait", minimum_tests: 2 },
    Suite { package: "lkjagent-app", target: "endpoint_credential_wait", minimum_tests: 2 },
...
const REQUIRED: &[(&str, &str, &str)] = &[
    ...
    ("lkjagent-core", "recovery_prompt", "strategy_changes_alter_prompt_and_smaller_prompt_bounds_context"),
    ...
    ("lkjagent-core", "runtime_eligibility", "progress_vectors_bind_facts_and_strategy"),
    ("lkjagent-core", "runtime_eligibility", "case_budgets_are_independent_dimensions"),
    ("lkjagent-app", "recovery_ladder", "repeated_parse_failure_advances_without_premature_block"),
    ("lkjagent-app", "progress_vector", "repeated_vector_emits_strategy_change_and_changed_strategy_resets_window"),
    ("lkjagent-app", "progress_vector", "changed_progress_releases_suspend_then_exhausts_to_visible_block"),
    ("lkjagent-app", "progress_vector", "vectors_keep_only_current_check_and_artifact_revisions"),
    ("lkjagent-app", "runtime_budget", "separate_case_budgets_use_durable_rows_and_block_truthfully"),
    ("lkjagent-app", "runtime_budget", "every_durable_budget_dimension_can_block_independently"),
    ("lkjagent-app", "endpoint_wait", "endpoint_retries_wait_until_due_then_stop_at_configured_limit"),
    ("lkjagent-app", "endpoint_wait", "interrupted_sent_request_blocks_without_a_second_provider_call"),
    ("lkjagent-app", "endpoint_credential_wait", "credential_rotation_wakes_once_without_persisting_the_secret"),
