...
pub(super) const FACTS: &[Fact] = &[
    ...
    fact("W08-deterministic", "crates/lkjagent-app/src/report_record.rs", &["artifacts/reports/{slug}.md", "source-lineage", "report document exceeds 512 conservative token units"]),
    fact("W08-deterministic", "crates/lkjagent-app/tests/report_flow.rs", &["report_create_replace_lineage_receipt_and_stale_guard_are_exact", "predicate_kind='managed-report'", "source_lineage"]),
