...
const FACTS: &[Fact] = &[
    ...
    fact("S04", "crates/lkjagent-app/src/config_registry.rs", &["endpoint_api_key_env", "endpoint_timeout_seconds", "live_campaign_seconds", "prompt_context_tokens", "workspace_root"]),
    fact("S04", "crates/lkjagent-app/src/config.rs", &["load_client", "api_key", "prompt_max_context_tokens", "live_campaign_seconds", "workspace_root"]),
    fact("S04", "crates/lkjagent-app/tests/configuration_contract.rs", &["tracked_example_matches_the_registry", "object.len(), 7", "rejects_unknown_composite_and_wrong_type_values"]),
