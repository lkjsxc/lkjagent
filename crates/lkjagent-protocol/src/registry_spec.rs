...
pub const TOOLS: &[ToolSpec] = &[
    ...
    tool("diary.record", crate::registry_personal::DIARY_RECORD, "create one diary record"),
    tool("diary.find", crate::registry_personal::DIARY_FIND, "find diary records"),
    tool("schedule.add", crate::registry_personal::SCHEDULE_ADD, "create one schedule record"),
    tool("schedule.list", crate::registry_personal::SCHEDULE_LIST, "list schedule records"),
    tool("schedule.update", crate::registry_personal::SCHEDULE_UPDATE, "update one schedule record"),
    tool("todo.add", crate::registry_personal::TODO_ADD, "create one TODO record"),
    tool("todo.list", crate::registry_personal::TODO_LIST, "list TODO records"),
    tool("todo.update", crate::registry_personal::TODO_UPDATE, "update one TODO record"),
