...
- [matter-control.rs](matter_control.rs): durable budget blocking.
...
- [journal-obligations.rs](journal_obligations.rs): exact file, mkdir, and managed journal obligations.
