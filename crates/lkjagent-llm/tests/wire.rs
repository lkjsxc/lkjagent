...
fn request_serializes_exact_documented_fields() -> TestResult<()> {
    ...
    assert_eq!(
        body,
        "{\"model\":\"local-model\",\"messages\":[{\"role\":\"system\",\"content\":\"system prefix\"},{\"role\":\"user\",\"content\":\"<owner>hello</owner>\"}],\"max_tokens\":1024,\"temperature\":0.3,\"top_p\":0.9,\"stop\":[\"</act>\"],\"stream\":false}"
    );
    Ok(())
}
